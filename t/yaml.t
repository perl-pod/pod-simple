...
Y 'plain 1', {str => "ab"}, "str:a\n b";
Y 'plain 2', {str => "ab"}, "str:a\n  b";
Y 'plain 3', {str => "abc"}, "str:a\n b\n c";
Y 'plain 4', {str => "abc"}, "str:a\n b\n                     c";
Y 'plain 5', {str => "ab", x => 1}, "str:a\n b\nx:1";
Y 'plain 6', {str => "a\nb"}, "str:a\n \n b";
Y 'plain 7', {str => "a\nb", x => 1}, "str:a\n \n b\nx:1";
...
Y 'q 1',                { str => "ab"}, "str:'a\n b'";
Y 'q 2',                { str => "abc"}, "str:'a\n b\n c'";
Y 'q 3',                { str => "ab", x => 1}, "str:'a\n b'\nx:1";
Y 'q 4/single CR',      { str => "a\nb"}, "str:'a\n \n b'";
Y 'q 5/comment',        { str => "ab"}, "str:'a\n b' # muahaha";
...
Y 'qq 1',                { str => "ab"}, "str:\"a\n b\"";
Y 'qq 2',                { str => "abc"}, "str:\"a\n b\n c\"";
Y 'qq 3',                { str => "ab", x => 1}, "str:\"a\n b\"\nx:1";
Y 'qq 4/single CR',      { str => "a\nb"}, "str:\"a\n \n b\"";
Y 'qq 5/comment',        { str => "ab"}, "str:\"a\n b\" # muahaha";
...
Y 'block folded/clip 1', {str => "_ab\nc\n"}, "str:>\n _a\n b\n \n c\n \n \n";
Y 'block folded/clip 2', {str => " ab\nc\n"}, "str:>1\n  a\n b\n \n c\n \n \n";
Y 'block folded/clip 3', {str => " ab\n c\n"}, "str:>1 # comment\n  a\n b\n \n  c\n \n \n";
N "str:>1 bad comment\n  a\n b\n \n c\n \n \n";
...
Y 'block folded/strip 1', {str => "_ab\nc"}, "str:>-\n _a\n b\n \n c\n \n \n";
Y 'block folded/strip 2', {str => " ab\nc"}, "str:>-1\n  a\n b\n \n c\n \n \n";
Y 'block folded/strip 3', {str => " ab\n c"}, "str:>-1 # comment\n  a\n b\n \n  c\n \n \n";
N "str:|-1 bad comment\n  a\n b\n \n c\n \n \n";
...
Y 'block folded/keep 1', {str => "_ab\nc\n\n"}, "str:>+\n _a\n b\n \n c\n \n \n";
Y 'block folded/keep 2', {str => " ab\nc\n\n"}, "str:>+1\n  a\n b\n \n c\n \n \n";
Y 'block folded/keep 3', {str => " ab\n c\n\n"}, "str:>+1 # comment\n  a\n b\n \n  c\n \n \n";
N "str:|+1 bad comment\n  a\n b\n \n c\n \n \n";
...
Y 'inline array', {a=>[1, 'b', 'foo bar', 'qq qq']}, "a: [1, b ,'foo bar' ,\"qq\\x20qq\"]";
Y 'inline hash',  {a=>{1 => 'b', 'foo bar' => 'qq qq'}}, "a: {1: b ,'foo bar': \"qq\\x20qq\"}";
Y 'inline array with arrays', {a=>[[1, 'b'], ['foo bar', 'qq qq']]}, "a: [[1, b] ,['foo bar' ,\"qq\\x20qq\"]]";
Y 'inline hash',  {a=>{x => {1 => 'b'}, y => {'foo bar' => 'qq qq'}}}, "a: {x:{1: b} ,y:{'foo bar': \"qq\\x20qq\"}}";
...
# anchors -- ignored
Y 'anchors', { foo => 1, bar => '' }, "foo: !!bool &A1 true\nbar: *A1";
...
Y 'set 2', [{ bar => 43 }], "- bar: 4\n  3";
Y 'set 3', [{ foo => 42 }, { bar => 43 }, { baz => 44 } ], "- foo: 42\n- bar: 4\n  3\n- baz: 44";
Y 'set 4', [{ foo => 42, bar => 43, baz => 44 } ], "- foo: 42\n bar: 4\n  3\n baz: 44";
Y 'set 5', {a => ['foo' ]}, "a:\n - foo";
Y 'set 6', {a => [{'foo' => 42} ]}, "a:\n - foo:42";
N "a:b\n - foo:4\n  2";
Y 'set 7', {a => [{'foo' => 42} ]}, "a:\n - foo:4\n  2";
...
Y 'set 9', {a => [{ foo => 42, bar => 43, baz => 44 } ]}, "a:\n - foo: 42\n  bar: 4\n   3\n  baz: 44";
